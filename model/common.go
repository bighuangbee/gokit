...
type UpdatedInfo struct {
	...
	UpdatedBy uint64       `json:"updatedBy,omitempty" dbupdate:"updated_by" gorm:"comment:更新者"`
}
type UpdatedByNameInfo struct {
	UpdatedByName string `json:"updatedByName,omitempty" dbupdate:"updated_by_name" gorm:"comment:更新者姓名"`
}
